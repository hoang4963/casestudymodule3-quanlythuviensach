...
<div class="content-w3ls">
    ...
    <div class="content-agile2">
        <form action="/register" method="post">
            ...
            <div class="form-control w3layouts">
                <input type="email" id="email" name="email" placeholder="mail@gmail.com" title="Please enter a valid email" >
            </div>

            <div class="form-control agileinfo">
                <input type="password" class="lock" name="password" placeholder="Password" id="password1" onchange="validatePassword()" >
            </div>

            <div class="form-control agileinfo">
                <input type="password" class="lock" name="confirm-password" placeholder="Confirm Password" id="password2" onchange="validatePassword()" >
            </div>
        ...
        <a href="/user/login.jsp" >Quay lại trang đăng nhập</a>
