    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a class="navbar-brand , comment" href="role/customer.jsp" style="font-style: oblique">LIBRARIES OF
                        GROUP II</a>
                </li>
            </ul>
        </div>
        ...
        <div >
            <ul class="leftSideTop">
                <li>
                    ...
                    <button class="leftSideTopBtn" onclick="location.href='roles';"><i class="fa fa-user-circle"></i>&emsp;Role</button>
                </li>
                <li>
                    <button class="leftSideTopBtn" onclick="location.href='customers';"><i class="fa fa-user"></i>&emsp;Customer</button>
                </li>
                <li>
                ...
                <li>
                    <button class="leftSideTopBtn" onclick="location.href='categories';"><i class="fa fa-envelope-o"></i>&emsp;Category</button>
                </li>
